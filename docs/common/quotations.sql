...
insert into quotations (nt_quotation_id, ot_id, nt_id, ot_book, psalm, ot_passage, nt_book, nt_passage, ot_startpos, ot_length, nt_startpos, nt_length, found_method) values
 (1242, 124, 2, 'Isaiah', null, 'LXX Isaiah 40:3 40:3-8', 'Luke', 'SBLGNT Luke 3:4+40 3:4', 78198, 70, 10561, 72, 'manual');
insert into quotations_properties (quotation_ot_id, quotation_nt_id, source_given, as_it_is_written) values
...
insert into clasps (nt_quotation_id, ot_id, nt_id, ot_book, ot_passage, nt_book, nt_passage, ot_startpos, ot_length, nt_startpos, nt_length) values
 (21132, 2113, 2, 'Exodus', 'LXX Exodus 3:6+40 3:6-70', 'Mark', 'SBLGNT Mark 12:26+96 12:26', 5018, 32, 40556, 30); -- αβρααμ και θεος ισαακ και θεος ιακωβ -> Αβρααμ και ο θεος Ισαακ και ο θεος Ιακωβ
insert into quotations (nt_quotation_id, ot_id, nt_id, ot_book, psalm, ot_passage, nt_book, nt_passage, ot_startpos, ot_length, nt_startpos, nt_length, found_method) values
