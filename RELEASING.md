...
* Change version date in version.h, snapcraft.yaml (Linux command line), eventually in qt/bibref.iss (Windows/Qt) and docker/qt/win/Dockerfile
...
* To create the Qt version (as WebAssembly build): remove
